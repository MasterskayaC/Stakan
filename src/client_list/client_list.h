...
public:
     ...
     */
    virtual void remove_bid(ClientId id, std::optional<common::ID> order_id = std::nullopt) = 0;
     ...
     */
    virtual void remove_ask(ClientId id, std::optional<common::ID> order_id = std::nullopt) = 0;
