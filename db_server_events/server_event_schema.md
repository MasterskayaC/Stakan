...
> 🔹 Связь с модулем и типом события хранится в коде через enum. FK в таблице необязателен.
...
**Пример C++ структуры для чтения из БД:**

```cpp
#include <chrono>
#include <string>
#include <nlohmann/json.hpp> // для metadata
